...
public class HUDButton : UdonSharpBehaviour
{
    ...
    [Tooltip("Is this global?\nTRUE - All players see the HUD Update\nFALSE - Only the player who clicks this sees the HUD Update.\nIf you're making an admin button, this should be true.")]
